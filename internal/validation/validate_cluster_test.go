...
func TestImageRegistry(t *testing.T) {
	ctx := context.Background()
	op := operation.Operation{Type: operation.Create}
	fldPath := field.NewPath("registry")
	...
	tests := []struct {
		...
		{
			name:      "string too long - invalid",
			value:     ptr.To(strings.Repeat("a", 256)),
			expectErr: true,
		},
		{
			name:      "hostname - valid",
			value:     ptr.To("registry.example.com"),
			expectErr: false,
		},
		{
			name:      "hostname with port - valid",
			value:     ptr.To("registry.example.com:5000"),
			expectErr: false,
		},
		{
			name:      "hostname with port and path - valid",
			value:     ptr.To("registry.example.com:5000/namespace/repo"),
			expectErr: false,
		},
		{
			name:      "localhost - valid",
			value:     ptr.To("localhost"),
			expectErr: false,
		},
		{
			name:      "localhost and port - valid",
			value:     ptr.To("localhost:5000"),
			expectErr: false,
		},
		{
			name:      "hostname with wildcard - valid",
			value:     ptr.To("*.registry.example.com"),
			expectErr: false,
		},
		{
			name:      "hostname with wildcard and path - valid",
			value:     ptr.To("*.registry.example.com/namespace/repo"),
			expectErr: false,
		},
		{
			name:      "hostname with wildcard and port - valid",
			value:     ptr.To("*.registry.example.com:5000"),
			expectErr: false,
		},
		{
			name:      "hostname with wildcard and port and path - valid",
			value:     ptr.To("*.registry.example.com:5000/namespace/repo"),
			expectErr: false,
		},
		{
			name:      "hostname with http prefix - invalid",
			value:     ptr.To("http://registry.example.com"),
			expectErr: true,
		},
		{
			name:      "hostname with https prefix - invalid",
			value:     ptr.To("https://registry.exmaple.com"),
			expectErr: true,
		},
		{
			name:      "hostname with upppercase letters - invalid",
			value:     ptr.To("REGISTRY.EXAMPLE.COM"),
			expectErr: true,
		},
		{
			name:      "hostname with spaces - invalid",
			value:     ptr.To("registry example.com"),
			expectErr: true,
		},
		{
			name:      "hostname with tab characters - invalid",
			value:     ptr.To("registry\texample.com"),
			expectErr: true,
		},
		{
			name:      "hostname with newline characters - invalid",
			value:     ptr.To("registry\nexample.com"),
			expectErr: true,
		},
		{
			name:      "hostname with carriage return characters - invalid",
			value:     ptr.To("registry\rexample.com"),
			expectErr: true,
		},
		{
			name:      "hostname with form feed characters - invalid",
			value:     ptr.To("registry\fexample.com"),
			expectErr: true,
		},
		{
			name:      "hostname with vertical tab characters - invalid",
			value:     ptr.To("registry\vexample.com"),
			expectErr: true,
		},
		{
			name:      "hostname with empty port - invalid",
			value:     ptr.To("registry.example.com:"),
			expectErr: true,
		},
		{
			name:      "hostname with multiple colons - invalid",
			value:     ptr.To("registry.example.com:5000:extra"),
			expectErr: true,
		},
		{
			name:      "hostname starting with dash - invalid",
			value:     ptr.To("-invalidhost.com"),
			expectErr: true,
		},
		{
			name:      "hostname ending with dash - invalid",
			value:     ptr.To("invalidhost-.com"),
			expectErr: true,
		},
		{
			name:      "hostname with underscore - invalid",
			value:     ptr.To("invalid_host.com"),
			expectErr: true,
		},
		{
			name:      "IPv4 address - valid",
			value:     ptr.To("192.168.1.1"),
			expectErr: false,
		},
		{
			name:      "IPv4 address with port - valid",
			value:     ptr.To("192.168.1.1:5000"),
			expectErr: false,
		},
		{
			name:      "IPv4 address with port and path - valid",
			value:     ptr.To("192.168.1.1:5000/namespace/repo"),
			expectErr: false,
		},
		{
			name:      "IPv4 loopback address - valid",
			value:     ptr.To("127.0.0.1"),
			expectErr: false,
		},
		{
			name:      "IPv4 loopback address with port - valid",
			value:     ptr.To("127.0.0.1:8080"),
			expectErr: false,
		},
		{
			name:      "IPv6 address with brackets - valid",
			value:     ptr.To("[2001:db8::1]"),
			expectErr: false,
		},
		{
			name:      "IPv6 address with brackets and port - valid",
			value:     ptr.To("[2001:db8::1]:5000"),
			expectErr: false,
		},
		{
			name:      "IPv6 address with brackets and port and path - valid",
			value:     ptr.To("[2001:db8::1]:5000/namespace/repo"),
			expectErr: false,
		},
		{
			name:      "IPv6 loopback address with brackets",
			value:     ptr.To("[::1]"),
			expectErr: false,
		},
		{
			name:      "IPv6 loopback address with brackets and port",
			value:     ptr.To("[::1]:8080"),
			expectErr: false,
		},
		{
			name:      "IPv6 address without brackets - valid",
			value:     ptr.To("2001:db8::1"),
			expectErr: false,
		},
		{
			name:      "IPv6 loopback address without brackets - valid",
			value:     ptr.To("::1"),
			expectErr: false,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			errs := ImageRegistry(ctx, op, fldPath, tt.value, nil)
